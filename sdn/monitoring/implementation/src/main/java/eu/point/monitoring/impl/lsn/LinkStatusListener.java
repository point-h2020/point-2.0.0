            ...
            for (Map.Entry<InstanceIdentifier<?>, DataObject> entrySet : updatedData.entrySet()) {
                ...
                if (dataobject instanceof NodeConnector) {
                    ...
                    NodeConnectorRegistryEntry ncRegistryEntry = NodeConnectorRegistryUtils
                            .getInstance().readFromNodeConnectorRegistry(nodeConnectorId);
                    ...
                    if (newState.isLinkDown() && !nodeConnectorsStatus.get(nodeConnectorId).booleanValue()) {
                    ...
                    else if (!newState.isLinkDown() && nodeConnectorsStatus.get(nodeConnectorId).booleanValue()){
                        LOG.info("Link is up!");
                        if (!srcNodeId.isEmpty() && !dstNodeId.isEmpty()) {
