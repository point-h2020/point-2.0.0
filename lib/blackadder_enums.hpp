 ...
 */
enum InformationItems
{
	MANAGEMENT_II_UNKNOWN, /*!< Unknown management information item */
	MANAGEMENT_II_DNS_LOCAL, /*!< Enable surrogate support in all NAPs */
...
enum RootNamespaces {
	...
	NAMESPACE_SURROGATE		/*!< Surrogate namespace */
};
