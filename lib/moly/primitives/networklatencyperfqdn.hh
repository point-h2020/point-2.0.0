...
#ifndef MOLY_PRIMITIVES_NETWORKLATENCYPERFQDN_HH_
#define MOLY_PRIMITIVES_NETWORKLATENCYPERFQDN_HH_
...
/*!
 * \brief Implementation of the NETWORK_LATENCY_PER_FQDN primitive
 */
class NetworkLatencyPerFqdn {
public:
	/*!
	 * \brief Constructor
	 *
	 ...
	 */
	NetworkLatencyPerFqdn(uint32_t fqdn, uint16_t latency);
	/*!
	 * \brief Constructor to read packet
	 */
	NetworkLatencyPerFqdn(uint8_t * pointer, size_t size);
	/*!
	 * \brief Destructor
	 */
...
#endif /* MOLY_PRIMITIVES_NETWORKLATENCYPERFQDN_HH_ */
