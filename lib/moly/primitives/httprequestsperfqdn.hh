...
#ifndef MOLY_PRIMITIVES_HTTPREQUESTSPERFQDN_HH_
#define MOLY_PRIMITIVES_HTTPREQUESTSPERFQDN_HH_
 ...
 */
class HttpRequestsPerFqdn {
public:
	/*!
	 * \brief Constructor for applications
	 */
	HttpRequestsPerFqdn(string fqdn, uint32_t httpRequests);
	/*!
	 * \brief Constructor for MAs
	 */
	HttpRequestsPerFqdn(uint8_t *pointer, uint32_t size);
	/*!
	 * \brief Destructor
	 */
	~HttpRequestsPerFqdn();
...
#endif /* MOLY_PRIMITIVES_HTTPREQUESTSPERFQDN_HH_ */
