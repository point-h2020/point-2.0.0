...
private:
	...
	*/
	...
	boost::thread_group *_tcpServerThreads;
	int _tcpListener;/*!< Pointer to socket listening for new TCP clients. Note,
	it must be a pointer. Otherwise, the main thread cannot call tearDown() and
	close the socket*/
};
