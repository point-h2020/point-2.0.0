...
public:
	 ...
	 * \brief Constructor
	 */
	Namespaces(Blackadder *icnCore, boost::mutex &icnCoreMutex,
	 ...
	 */
	void endOfSession(IcnId &cid, uint16_t &sessionKey);
	/*!
	 ...
	 */
	void sendToEndpoint(IcnId &rCid, uint8_t *packet, uint16_t &packetSize);
	/*!
	 ...
	 */
	void surrogacy(IcnId &cid, uint16_t command);
	/*!
