...
public:
	 ...
	 *
	 * Boost functor to call this method in a thread
	 */
	void operator()();
private:
	...
	/*!
	 * \brief Check if packet should be processed
	 *
	 * As all packets towards IP endpoints served by the NAP are also captured
	 * by PCAP, it must be ensured that they do not enter the IP handler again.
	 *
	 * \return Boolean indicating whether packet should be dropped or not
	 */
	bool _ignorePacket(IpAddress *sourceIpAddress,
