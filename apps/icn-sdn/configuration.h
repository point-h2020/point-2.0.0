...
public:
	 ...
	 *
	 */
	configuration(bool flag);
	virtual ~configuration();

	/**@brief The method which initializes click.
	 *
	 */
	void initialize_click();
	 ...
	 * @param new_internal_lid The new internal link identifier.
	 * @param new_link_id The new link identifier.
	 *
	 */
	void update_click(string new_node_id, string new_rv_fid, string new_tm_fid,
			string new_internal_lid, string new_link_id);
