...
/**@brief The resource manager class.
 *
 * It will generate unique node, link and internal link identifiers, and also keep track of assigned ones.
 *
...
public:
	 ...
	 *
	 */
	string generate_link_id_from_icn(string tmfid, string mac_address);
