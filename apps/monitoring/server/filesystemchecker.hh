...
private:
	 ...
	 */
	BampersInformationItems _attribute(uint16_t dataPoint);
	/*!
	 * \brief Obtain the node type from the attribute/data point (moly/enum.hh)
	 *
	 * \param dataPoint The data point which allows to determine the node type
	 *
	 * \return The node type
	 */
	NodeTypes _nodeType(uint16_t dataPoint);
};
