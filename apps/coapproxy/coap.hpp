...
class CoAP_packet{
	...
	public:
		...
		* @see enum Options
		* @param optionLength The length of the optionValue
		* @param optionValue 
		*/		
		int insertOption(uint16_t optionType, uint16_t optionLength, uint8_t *optionValue);
	...
	private:
		...
		int __optionCount;
		unsigned short __maxDelta;	/**<highest option number*/       
